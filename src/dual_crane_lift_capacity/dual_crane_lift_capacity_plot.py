...
def create_plots(lift_cases: lift_cases.LiftCases,
    ...
    for i in range(len(lift_cases.cases)):
        figures[lift_cases.cases[i]] = _create_plot(
            lift_cases.cases[i],
            lift_cases.weights[i],
            lift_cases.cogs[i],
            lift_cases.lift_points_a[i],
            lift_cases.lift_points_b[i],
            lift_cases.crane_radii_a[i],
            lift_cases.crane_radii_b[i],
            lift_cases.rigging_weights_a[i],
            lift_cases.rigging_weights_b[i],
            lift_cases.crane_curves_a[i],
            lift_cases.crane_curves_b[i],
            lift_cases.crane_capacities_a[i],
            lift_cases.crane_capacities_b[i],
            lift_cases.tilt_factors[i],
            lift_cases.cogs[i],
            lift_cases.weight_uncertainty_factors[i],
